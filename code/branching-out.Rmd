...
Visit the [Inter-university Consortium for Political and Social Research](https://www.icpsr.umich.edu/web/ICPSR/studies/28023) for additional 
information. 
...
-	`classProbs` and `summaryFunction` provide specifications related to the performance measures
...
above to determine the implications of providing the intervention to different 
...
who will receive the intervention, while every value below the cutoff is 
colored blue to indicate that students who will not receive the intervention. 
